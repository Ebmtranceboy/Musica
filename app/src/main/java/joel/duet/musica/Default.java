...
final class Default {
    ...
    public static final Flavor[] flavors = {
            ...
            // borrowred chords
            new Flavor(true, "\u266DII7", 1, 5, 8, 11),
            new Flavor(true, "ii7", 2, 5, 9, 12),
            new Flavor(true, "ii\u00F87", 2, 5, 8, 12),
            new Flavor(true, "III", 4, 8, 11),
            new Flavor(true, "\u266DIII", 3, 7, 10),
            new Flavor(true, "\u266Diii", 3, 6, 10),
            new Flavor(true, "iv", 5, 8, 12),
            new Flavor(true, "iv7", 5, 8, 12, 15),
            new Flavor(true, "IV7", 5, 9, 12, 15),
            new Flavor(true, "IVM7", 5, 9, 12, 16),
            new Flavor(true, "V7", -5, -1, 2, 5),
            new Flavor(true, "V\u266D9", -5, -1, 2, 5, 8),
            ...
            new Flavor(true, "\u266DVII7", -2, 2, 5, 8),
            // secondary dominants
            new Flavor(true, "V7/ii", -3, 1, 4, 7),
            new Flavor(true, "V7/iii", -1, 3, 6, 9),
            ...
            new Flavor(true, "vii\u00F87/ii", 1, 4, 7, 11),
            new Flavor(true, "vii\u00F87/iii", 3, 6, 9, 13),
            new Flavor(true, "vii\u00F87/IV", 4, 7, 10, 14),
            ...
            new Flavor(false, "ii", 2, 5, 9),
            new Flavor(false, "iii", 3, 6, 10),
            new Flavor(false, "III+", 3, 7, 11),
            new Flavor(false, "\u266Fiii", 4, 7, 11),
            new Flavor(false, "\u266FIII", 4, 8, 11),
            new Flavor(false, "IV", 5, 9, 12),
            new Flavor(false, "vi", -4, -1, 3),
            new Flavor(false, "\u266Fvi", -3, 0, 4),
            new Flavor(false, "\u266Fvi°", -3, 0, 3),
            new Flavor(false, "\u266FVI", -3, 1, 4),
            // secondary dominants
            new Flavor(false, "V7/III", -2, 2, 5, 8),
            ...
            // secondary leading tone half-diminished chords
            new Flavor(false, "vii\u00F87/III", 2, 5, 8, 12),
            new Flavor(false, "vii\u00F87/iv", 4, 7, 10, 14),
