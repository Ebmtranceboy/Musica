...
final class Default {
    ...
    public static final String empty_project = "{\"Globals\":\"" + material + "\",\"GainL\":1.0,\"GainR:1.0\",\"Tempo\":1.0,\"Orchestra\":[],\"FX\":[],\"idTrackSelected\":0,\"idPatternSelected\":0,\"tracks\":[],\"Matrix\":\"FF\"}";
