...
final class Default {
    ...
    public static final Flavor[] flavors = {
            ...
            new Flavor(true, "viih7/V", -6, -3, 0, 4),
            new Flavor(true, "viih7/vi", -4, -1, 2, 6),
            //
            // MINOR
            // diatonic triads
            ...
            new Flavor(false, "svi", -3, 0, 4),
            new Flavor(false, "sVI", -3, 1, 4),
            // secondary dominants
            ...
            new Flavor(false, "viih7/V", -6, -3, 0, 4),
            new Flavor(false, "viih7/VI", -5, -2, 1, 5),
            new Flavor(false, "viih7/VII", -3, 0, 3, 7)
    };
}
